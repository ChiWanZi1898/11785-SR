...
class checkpoint():
    ...
    def save_results(self, filename, save_list, scale):
        ...
        for v, p in zip(save_list, postfix):
            # normalized = v.data.mul(255 / self.args.rgb_range)
            # ndarr = v.byte().permute(1, 2, 0).cpu().numpy()
            imageio.imsave('{}{}.png'.format(filename, p), v)
    ...
    def save_results_nopostfix(self, filename, save_list, scale):
        ...
        for v, p in zip(save_list, postfix):
            ...
            imageio.imsave('{}.png'.format(filename), v)
